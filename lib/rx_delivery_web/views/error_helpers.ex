defmodule RxDeliveryWeb.ErrorHelpers do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RxDeliveryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RxDeliveryWeb.Gettext, "errors", msg, opts)
    end
  end
end
