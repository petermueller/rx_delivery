defmodule RxDelivery.Patients do
  @moduledoc """
  ...
  def list_orders(:with_assocs) do
    Repo.all(orders_with_assocs_query())
  end
  ...
  def get_order!(id, :with_assocs), do: Repo.get!(orders_with_assocs_query(), id)
  ...
  defp orders_with_assocs_query do
